...
<title>{{$city->name}} & {{$type->name}} SERVICES | {{App\Models\Setting::siteName()}}</title>
...
<div class="sb-breadcrumbs breadcrumb-bg ">
	<ul class="breadcrumb ">
	   ...
	   <li class="breadcrumb-item">
			<i class="fa fa-home"></i>
		  <a href="{{url('services')}}" class="breadcrumb-label">{{$city->name}} & {{$type->name}} Service Provider</a>
	   </li>
	</ul>
 </div>
 <div class="row page">
	...
	<main class="col-lg-9 col-md-12 page-content" id="product-listing-container">
	   <div class="products-category clearfix">
		  <div class="form-group category-info">
			 <h3 class="title-category ">{{$city->name}} & {{$type->name}} Services</h3>
