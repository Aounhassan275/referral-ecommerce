                                ...
                                <div class="mobile-verticalCategories is-open" id="mobile--verticalCategories" aria-hidden="true" tabindex="-1">
                                    ...
                                    <ul class="navPages-list navPages-list--categories">  
                                        ...
                                        <li class="navPages-item navPages-item--default ">
                                            <a class="navPages-action" href="{{route('post.category.show',str_replace(' ', '_',$post_category->name))}}">
                                                <i class="fa fa-mobile"></i> {{$post_category->name}} </a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <form class="sb-searchpro" action="products">
                                <fieldset class="form-fieldset">
                                    <div class="input-group">
                                        <input class="form-control form-input"  name="keyword" id="search_query" data-error-message="Search field cannot be empty." placeholder="Search the store" autocomplete="off">
                                ...
                                <nav class="navPages-horizontal navPages-container" id="menumobile-horizontal">
                                    ...
                                    <ul class="navPages-list">
                                        <li class="navPages-item ">
                                            <a class="navPages-action" href="{{url('post/categories')}}"> Category </a>
                                        </li>
                                        <li class="navPages-item ">
                                            <a class="navPages-action" href="{{url('post/brands')}}"> Brand </a>
                                        </li>
                                        <li class="navPages-item ">
                    ...
                    <div class="col-lg-6 col-md-2 col-4 ">
                        <nav class="navPages-horizontal navPages-container" id="menu">
                            ...
                            <ul class="navPages-list">
                                ...
                                <li class="navPages-item ">
                                    <a class="navPages-action" href="{{url('post/countries')}}"> Countries </a>
                                </li>
                                <li class="navPages-item ">
                                    <a class="navPages-action" href="{{url('post/cities')}}"> Cities </a>
                                </li>
                                <li class="navPages-item ">
                                    <a class="navPages-action" href="{{url('posts')}}"> Post </a>
                                </li>
