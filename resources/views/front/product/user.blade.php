      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              <div class="col-lg-3 menu-item">
                <a href="{{asset('profile-theme-assets/assets/img/menu/menu-item-1.png')}}" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-1.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="{{asset('profile-theme-assets/assets/img/menu/menu-item-2.png')}}" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-2.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Aut Luia</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="{{asset('profile-theme-assets/assets/img/menu/menu-item-3.png')}}" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-3.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Est Eligendi</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="{{asset('profile-theme-assets/assets/img/menu/menu-item-4.png')}}" class="glightbox">
                    <img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-4.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="{{asset('profile-theme-assets/assets/img/menu/menu-item-5.png')}}" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-5.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="{{asset('profile-theme-assets/assets/img/menu/menu-item-6.png')}}" class="glightbox">
                    <img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-6.png')}}" class="menu-img img-fluid" alt=""></a>
          ...
          <div class="tab-pane fade" id="menu-breakfast">
            ...
            <div class="row gy-5">
              <div class="col-lg-3 menu-item">
                <a href="profile-theme-assets/assets/img/menu/menu-item-1.png" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-1.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="profile-theme-assets/assets/img/menu/menu-item-2.png" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-2.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Aut Luia</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="profile-theme-assets/assets/img/menu/menu-item-3.png" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-3.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Est Eligendi</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="profile-theme-assets/assets/img/menu/menu-item-4.png" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-4.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="profile-theme-assets/assets/img/menu/menu-item-5.png" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-5.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <!-- Menu Item -->
              <div class="col-lg-3 menu-item">
                <a href="profile-theme-assets/assets/img/menu/menu-item-6.png" class="glightbox"><img src="{{asset('profile-theme-assets/assets/img/menu/menu-item-6.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>Laboriosam Direva</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
