...
<title>{{$brand->name}} & {{$city->name}} PRODUCTS | {{App\Models\Setting::siteName()}}</title>
...
<div class="sb-breadcrumbs breadcrumb-bg ">
	<ul class="breadcrumb ">
	   ...
	   <li class="breadcrumb-item">
			<i class="fa fa-home"></i>
		  <a href="{{url('brands')}}" class="breadcrumb-label">City</a>
	   </li>
	   <li class="breadcrumb-item is-active">
		  <a href="{{url('brands')}}" class="breadcrumb-label">{{$brand->name}} & {{$city->name}} Products</a>
	   </li>
	</ul>
 </div>
 <div class="row page">
	...
	<main class="col-lg-9 col-md-12 page-content" id="product-listing-container">
	   <div class="products-category clearfix">
		  <div class="form-group category-info">
			 <h3 class="title-category ">{{$brand->name}} & {{$city->name}} Products</h3>
