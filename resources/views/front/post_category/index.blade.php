			...
			<div class="product-layout product-grid product-grid-4 col-lg-3 col-md-4 col-6">
				<article class="product-item-container ">
					...
					<div class="right-block">
						<h4 class="card-title">
							<a href="{{route('post.category.show',str_replace(' ', '_',$category->name))}}">{{$category->name}}</a>
						</h4>
						...
						<div class="button-group">
							<div class="action-item addToCart">
								<a href="{{route('post.category.show',str_replace(' ', '_',$category->name))}}" data-wait-message="Add to Cart" class="action-link  button--cart" title="Add to Cart">View</a>
							</div>
						</div>
					</div>
				</article>
