...
<div class="sb-breadcrumbs breadcrumb-bg ">
	<ul class="breadcrumb ">
	   ...
	   <li class="breadcrumb-item">
			<i class="fa fa-home"></i>
		  <a href="{{url('post/categories')}}" class="breadcrumb-label">Categories</a>
	   </li>
	   <li class="breadcrumb-item is-active">
		  <a href="{{url('post/categories')}}" class="breadcrumb-label">{{$category->name}} BRANDS</a>
	   </li>
	</ul>
 </div>
 <div class="row page">
			...
			<div class="product-layout product-grid product-grid-4 col-lg-3 col-md-4 col-6">
				<article class="product-item-container ">
					...
					<div class="right-block">
						<h4 class="card-title">
							<a href="{{route('post.brand.show',str_replace(' ', '_',$brand->name))}}">{{$brand->name}}</a>
						</h4>
						<div class="price-section price-section--withoutTax ">
							<span data-product-price-without-tax class="price price--withoutTax">({{$brand->posts->count()}})</span>
						</div>
						<div class="button-group">
							<div class="action-item addToCart">
								<a href="{{route('post.brand.show',str_replace(' ', '_',$brand->name))}}"  class="" title="Add to Cart">View</a>
							</div>
						</div>
					</div>
				</article>
