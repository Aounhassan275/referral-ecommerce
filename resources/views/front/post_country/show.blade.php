...
<div class="sb-breadcrumbs breadcrumb-bg ">
	<ul class="breadcrumb ">
	   ...
	   <li class="breadcrumb-item is-active">
		  <a href="{{url('post/countries')}}" class="breadcrumb-label">{{$country->name}} Cities</a>
	   </li>
	</ul>
 </div>
 <div class="row page">
			...
			<div class="product-layout product-grid product-grid-4 col-lg-3 col-md-4 col-12">
				<article class="product-item-container ">
					<div class="right-block">
						<h4 class="card-title">
							<a href="{{route('post.city.show',str_replace(' ', '_',$city->name))}}">{{$city->name}}  ({{$city->posts->count()}})</a>
						</h4>
					</div>
				</article>
			</div>
