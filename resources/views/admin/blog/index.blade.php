...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>VIEW BLOG | {{App\Models\Setting::siteName()}}</h3>
    </div>
</div>
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Blog Table</h5>
            <a href="{{route('admin.blog.create')}}" class="btn btn-primary text-right">Add New Blog</a>
        </div>
            ...
            <table id="datatables-buttons" class="table table-striped ">
                <thead>
                    <tr>
                        ...
                        <th style="width:auto;">Blog Name</th>
                        <th style="width:auto;">Blog Url</th>
                        <th style="width:auto;">Blog Category</th>
