...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>Add Service | {{App\Models\Setting::siteName()}}</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        ...
        <table class="table" id="datatables-reponsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$service->name}}</td>
                    <td>
                        <button data-toggle="modal" data-target="#edit_modal" name="{{$service->name}}" 
                                id="{{$service->id}}" class="edit-btn btn btn-primary">Edit</button>
                        </td>
                    <td>
...
<script>
    $(document).ready(function(){
        $('.edit-btn').click(function(){
            ...
            $('#name').val(name);
            $('#id').val(id);
            $('#updateForm').attr('action','{{route('admin.service.update','')}}' +'/'+id);
        });
    });
</script>
<script>
