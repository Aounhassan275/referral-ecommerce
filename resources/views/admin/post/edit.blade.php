...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>Update {{$post->name}} Post Information | {{App\Models\Setting::siteName()}}</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Update {{$post->name}} Post Information</h5>
            </div>
            <div class="card-body">
                <form action="{{route('admin.post.update',$post->id)}}" method="post" enctype="multipart/form-data">
                   ...
                   <div class="row">
                        <div class="form-group col-4">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Product Name" value="{{@$post->name}}">
                        </div>
                        <div class="form-group col-4">
                        ...
                        <div class="form-group col-4">
                            <label class="form-label">Post Brand</label>
                   ...
                   <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <select name="city_id" id="city_id" class="form-control select2" required>
                            <option selected disabled>Select</option>
                            @foreach(App\Models\City::where('country_id',$post->country_id)->get() as $city)
            ...
            <table id="datatables-buttons" class="table table-striped ">
                <thead>
                    <tr>
                        ...
                        <th style="width:auto;">Post Image</th>
                ...
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td class="table-action">
                            ...
                            <form action="{{route('admin.post_image.destroy',$image->id)}}" method="POST">
                                @method('DELETE')
                                @csrf
...
<div id="add_image_model" class="modal fade">
    <div class="modal-dialog">
        <form action="{{route('admin.post_image.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
