                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select name="type" class="form-control" id="" required>
                                ...
                                <option value="2">For Client</option>
                            </select>                    
                        </div>
                        <div class="form-group col-4">
                    ...
                    <tr> 
                        ...
                        <td class="table-action">
                            <button data-toggle="modal" data-target="#edit_modal" name="{{$payment->name}}" 
                                method="{{$payment->method}}" type="{{$payment->type}}" number="{{$payment->number}}" bnumber="{{$payment->bnumber}}" bank="{{$payment->bank}}" id="{{$payment->id}}" class="edit-btn btn"><i class="align-middle" data-feather="edit-2"></i></button>
                        </td>
                        <td class="table-action">
