...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View Your Pool Income History</h5>
    ...
    <table class="table  datatable-basic datatable-row-basic">
        ...
        <tbody>
            @foreach (Auth::user()->poolIncome as $key => $income)
                <tr>
                    <td>{{$key+1}}</td>
...
<div class="row" >
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('user.earning.pool_income') }}" method="get">
                    <div class="row">
