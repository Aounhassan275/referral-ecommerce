...
class AuthController extends Controller
{
    ...
    {
        $user= User::where('code',$code)->first();
        return view('front.auth.register')->with('code',$code)->with('user',$user);
    }
    ...
    public function verification(Request $request){
        ...
        if($user->birth_place == $request->birth_place && $user->favourite_place == $request->favourite_place  && $user->favourite_uncle == $request->favourite_uncle )
        {
            return response()->json([
                'status' => true,
                'user_id' => $user->id,
