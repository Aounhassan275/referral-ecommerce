...
Route::get('brand/{name}', 'App\Http\Controllers\FrontendController@showBrandDetails')->name('brand.show');
Route::get('brand/{brand_name}/city/{city_name}', 'App\Http\Controllers\FrontendController@showProductCityDetails')->name('brand.city_show');
Route::get('cities', 'App\Http\Controllers\FrontendController@showCities')->name('city.index');
Route::get('city/{name}', 'App\Http\Controllers\FrontendController@showCityDetails')->name('city.show');
Route::get('countries', 'App\Http\Controllers\FrontendController@showCountries')->name('country.index');
Route::get('country/{name}', 'App\Http\Controllers\FrontendController@showCountryDetails')->name('country.show');
...
Route::post('check_refferral_code', 'App\Http\Controllers\FrontendController@check_refferral_code')->name('check_refferral_code');
...
Route::post('our_service/types', 'App\Http\Controllers\ServiceFrontendController@getServiceTypes')->name('service.types');
Route::get('services', 'App\Http\Controllers\ServiceFrontendController@showServices')->name('services.index');
Route::get('services/{name}', 'App\Http\Controllers\ServiceFrontendController@showServicesDetails')->name('services.show');
Route::get('service_types', 'App\Http\Controllers\ServiceFrontendController@showServiceTypes')->name('service_types.index');
Route::get('service_types/{name}', 'App\Http\Controllers\ServiceFrontendController@showServiceTypeDetails')->name('service_types.show');
Route::get('service_cities', 'App\Http\Controllers\ServiceFrontendController@showCities')->name('service_cities.index');
Route::get('service_cities/{name}', 'App\Http\Controllers\ServiceFrontendController@showCityDetails')->name('service_cities.show');
Route::get('service_countries', 'App\Http\Controllers\ServiceFrontendController@showCountries')->name('service_countries.index');
Route::get('service_countries/{name}', 'App\Http\Controllers\ServiceFrontendController@showCountryDetails')->name('service_countries.show');
Route::post('search_service_type', 'App\Http\Controllers\ServiceFrontendController@search_service_type')->name('search_service_type');
Route::get('service/type/{type_name}/city/{city_name}', 'App\Http\Controllers\ServiceFrontendController@showServiceCityDetails')->name('service.type.city_show');
//Post Routes  
Route::get('posts', 'App\Http\Controllers\PostFrontendController@showPosts')->name('post.index');
Route::get('post/detail/{name}', 'App\Http\Controllers\PostFrontendController@showPostDetails')->name('post.show');
Route::get('post/categories', 'App\Http\Controllers\PostFrontendController@showCategory')->name('post.category.index');
Route::get('post/category/{name}', 'App\Http\Controllers\PostFrontendController@showCategoryDetails')->name('post.category.show');
Route::get('post/brands', 'App\Http\Controllers\PostFrontendController@showBrands')->name('post.brand.index');
Route::get('post/brand/{name}', 'App\Http\Controllers\PostFrontendController@showBrandDetails')->name('post.brand.show');
Route::get('post/cities', 'App\Http\Controllers\PostFrontendController@showCities')->name('post.city.index');
Route::get('post/city/{name}', 'App\Http\Controllers\PostFrontendController@showCityDetails')->name('post.city.show');
Route::get('post/countries', 'App\Http\Controllers\PostFrontendController@showCountries')->name('post.country.index');
Route::get('post/country/{name}', 'App\Http\Controllers\PostFrontendController@showCountryDetails')->name('post.country.show');
Route::get('post/brand/{brand_name}/city/{city_name}', 'App\Http\Controllers\PostFrontendController@showProductCityDetails')->name('post.brand.city_show');
//Normal Routes
